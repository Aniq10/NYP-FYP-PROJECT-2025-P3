...
from utils import rel2abspath, create_folders # NEW: Import create_folders
...
# NEW: Read the directory and create the folder using that directory if it does not exist
USER_DB_PATH = rel2abspath(os.getenv('USER_DB_PATH', r'.\data\users\users.json')) # NEW: Fallback directory
create_folders(USER_DB_PATH)
CHAT_SESSIONS_PATH = rel2abspath(os.getenv('CHAT_SESSIONS_PATH', r'.\data\chat_sessions')) # NEW: Fallback directory
create_folders(CHAT_SESSIONS_PATH)
